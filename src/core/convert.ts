...
export function positionADiasTotales(pos: TimePosition): number {
    return (pos.era - 1) * DIAS_POR_ERA + (pos.periodo - 1) * DIAS_POR_PERIODO + (pos.semana - 1) * DIAS_POR_SEMANA + pos.dia - 1
}
